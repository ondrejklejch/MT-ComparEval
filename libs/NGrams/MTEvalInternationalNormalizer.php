...
/**
 * MTEvalInternationalNormalizer is used for adding spaces between words
 *
 * @see ftp://jaguar.ncsl.nist.gov/mt/resources/mteval-v13a.pl --international-tokenization
 */
class MTEvalInternationalNormalizer implements INormalizer {
